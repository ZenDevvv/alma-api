...
export const router = (route: Router, controller: IController): Router => {
	 ...
	 *     description: Retrieve a specific transaction by its unique identifier with optional field selection
	 *     tags: [Transaction]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 */
	// Cache individual transaction with predictable key for invalidation
	routes.get(
		"/:id",
		cache({
			ttl: 90,
	 ...
	 *     description: Retrieve transactions with advanced filtering, pagination, sorting, field selection, and optional grouping
	 *     tags: [Transaction]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *         $ref: '#/components/responses/InternalServerError'
	 */
	// Cache transaction list with predictable key for invalidation
	routes.get(
		"/",
		cache({
			ttl: 60,
	 ...
	 *                 example: "Email Welcome Transaction"
	 *               description:
	 *                 type: string
	 *                 description: Transaction description
	 *                 example: "Welcome email transaction for new users"
	 *               type:
	 *                 type: string
	 ...
	 *                 minLength: 1
	 *                 description: Transaction name
	 *                 example: "Updated Email Transaction"
	 *               description:
	 *                 type: string
	 *                 description: Transaction description
	 *                 example: "Updated description for the transaction"
	 *               type:
	 *                 type: string
	 *                 enum: ["email", "sms", "push", "form"]
	 *                 description: Transaction type for categorization
