...
export const router = (route: Router, controller: IController): Router => {
	 ...
	 *     description: Retrieve a specific deliveryOrder by its unique identifier with optional field selection
	 *     tags: [DeliveryOrder]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *         description: DeliveryOrder ID (MongoDB ObjectId format)
	 ...
	 *     responses:
	 *       200:
	 *         description: DeliveryOrder retrieved successfully
	 *         content:
	 *           application/json:
	 *             schema:
	 *               allOf:
	 ...
	 */
	// Cache individual deliveryOrder with predictable key for invalidation
	routes.get(
		"/:identifier",
		cache({
			ttl: 90,
	 ...
	 * /api/deliveryOrder:
	 *   get:
	 *     summary: Get all deliveryOrders
	 *     description: Retrieve deliveryOrders with advanced filtering, pagination, sorting, field selection, and optional grouping
	 *     tags: [DeliveryOrder]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *           type: string
	 *           enum: ["true"]
	 *         description: Include deliveryOrder documents in response
	 *       - in: query
	 *         name: pagination
	 *         required: false
	 *         schema:
	 ...
	 *         $ref: '#/components/responses/InternalServerError'
	 */
	// Cache deliveryOrder list with predictable key for invalidation
	routes.get(
		"/",
		cache({
			ttl: 60,
	 ...
	 * /api/deliveryOrder:
	 *   post:
	 *     summary: Create new deliveryOrder
	 *     description: Create a new deliveryOrder with the provided data
	 *     tags: [DeliveryOrder]
	 *     security:
	 *       - bearerAuth: []
	 *     requestBody:
	 ...
	 *                 example: "Email Welcome DeliveryOrder"
	 *               description:
	 *                 type: string
	 *                 description: DeliveryOrder description
	 *                 example: "Welcome email deliveryOrder for new users"
	 *               type:
	 *                 type: string
	 *                 enum: ["email", "sms", "push", "form"]
	 *                 description: DeliveryOrder type for categorization
	 *                 example: "email"
	 *               isDeleted:
	 *                 type: boolean
	 ...
	 *     responses:
	 *       201:
	 *         description: DeliveryOrder created successfully
	 *         content:
	 *           application/json:
	 *             schema:
	 *               allOf:
	 ...
	 * /api/deliveryOrder/{id}:
	 *   patch:
	 *     summary: Update deliveryOrder
	 *     description: Update deliveryOrder data by ID (partial update)
	 *     tags: [DeliveryOrder]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *                 minLength: 1
	 *                 description: DeliveryOrder name
	 *                 example: "Updated Email DeliveryOrder"
	 *               description:
	 *                 type: string
	 *                 description: DeliveryOrder description
	 *                 example: "Updated description for the deliveryOrder"
	 *               type:
	 *                 type: string
	 *                 enum: ["email", "sms", "push", "form"]
	 *                 description: DeliveryOrder type for categorization
	 ...
	 *     responses:
	 *       200:
	 *         description: DeliveryOrder updated successfully
	 *         content:
	 *           application/json:
	 *             schema:
	 *               allOf:
	 ...
	 * /api/deliveryOrder/{id}:
	 *   delete:
	 *     summary: Delete deliveryOrder
	 *     description: Permanently delete a deliveryOrder by ID
	 *     tags: [DeliveryOrder]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *     responses:
	 *       200:
	 *         description: DeliveryOrder deleted successfully
	 *         content:
	 *           application/json:
	 *             schema:
	 *               allOf:
