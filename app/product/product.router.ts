...
export const router = (route: Router, controller: IController): Router => {
	 ...
	 *     description: Retrieve a specific product by its unique identifier with optional field selection
	 *     tags: [Product]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *         description: Product ID (MongoDB ObjectId format)
	 ...
	 */
	// Cache individual product with predictable key for invalidation
	routes.get(
		"/:id",
		cache({
			ttl: 90,
			keyGenerator: (req: Request) => {
				...
				return `cache:product:byId:${req.params.id}:${fields}`;
			},
		}),
		controller.getById,
	);
	 ...
	 *     description: Retrieve products with advanced filtering, pagination, sorting, field selection, and optional grouping
	 *     tags: [Product]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *           type: string
	 *           enum: ["true"]
	 *         description: Include product documents in response
	 *       - in: query
	 *         name: pagination
	 *         required: false
	 *         schema:
	 ...
	 *         $ref: '#/components/responses/InternalServerError'
	 */
	// Cache product list with predictable key for invalidation
	routes.get(
		"/",
		cache({
			ttl: 60,
	 ...
	 *                 example: "Email Welcome Product"
	 *               description:
	 *                 type: string
	 *                 description: Product description
	 *                 example: "Welcome email product for new users"
	 *               type:
	 *                 type: string
	 ...
	 *         $ref: '#/components/responses/InternalServerError'
	 */
	routes.post("/", verifyRole(["admin:super:*"]), controller.create);
	 ...
	 *     description: Update product data by ID (partial update)
	 *     tags: [Product]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
