...
export const router = (route: Router, controller: IController): Router => {
	 ...
	 *     description: Retrieve a specific supplier by its unique identifier with optional field selection
	 *     tags: [Supplier]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *         description: Supplier ID (MongoDB ObjectId format)
	 ...
	 */
	// Cache individual supplier with predictable key for invalidation
	routes.get(
		"/:id",
		cache({
			ttl: 90,
	 ...
	 *     description: Retrieve suppliers with advanced filtering, pagination, sorting, field selection, and optional grouping
	 *     tags: [Supplier]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *           type: string
	 *           enum: ["true"]
	 *         description: Include supplier documents in response
	 *       - in: query
	 *         name: pagination
	 *         required: false
	 *         schema:
	 ...
	 *         $ref: '#/components/responses/InternalServerError'
	 */
	// Cache supplier list with predictable key for invalidation
	routes.get(
		"/",
		cache({
			ttl: 60,
	 ...
	 *                 example: "Email Welcome Supplier"
	 *               description:
	 *                 type: string
	 *                 description: Supplier description
	 *                 example: "Welcome email supplier for new users"
	 *               type:
	 *                 type: string
	 *                 enum: ["email", "sms", "push", "form"]
	 *                 description: Supplier type for categorization
	 *                 example: "email"
	 *               isDeleted:
	 *                 type: boolean
	 ...
	 *     description: Update supplier data by ID (partial update)
	 *     tags: [Supplier]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *                 minLength: 1
	 *                 description: Supplier name
	 *                 example: "Updated Email Supplier"
	 *               description:
	 *                 type: string
	 *                 description: Supplier description
	 *                 example: "Updated description for the supplier"
	 *               type:
	 *                 type: string
	 *                 enum: ["email", "sms", "push", "form"]
	 *                 description: Supplier type for categorization
